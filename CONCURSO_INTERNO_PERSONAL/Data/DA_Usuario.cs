...
namespace CONCURSO_INTERNO_PERSONAL.Data
{
    public class DA_Usuario
    {
        public List<Usuario> ListaUsuario()
        {
            ...
            {
                new Usuario{Nombre = "admin",Correo = "admin@gmail.com",Clave="admin",Roles=new string[]{"admin"} },
                ...
                new Usuario{Nombre = "Eddie Paz", Correo = "comiteSeleccion@gmail.com", Clave = "123", Roles = new string[] { "comiteSeleccion"} },
